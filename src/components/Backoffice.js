...
const CollapsibleComponent = () => {
  ...
  const handleSaveChanges = (userId, userDTO) => {
    updateUser(userId, userDTO).then((resp) => {
        ...
        <div className="userButton" key={index}>
          <button
            ...
            className={`collapsible ${
              isCollapsibleActive(index) ? "active" : ""
            }`}
          ...
          <div
            className={`content ${isCollapsibleActive(index) ? "active" : ""}`}
          >
            ...
            <div className="bo-input">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange(index, "sessionId", e.target.value)
                }
              />
            </div>
            <div className="bo-input">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange(index, "kycStatus", e.target.value)
                }
              />
            </div>
            <div className="bo-input">
            ...
            <div className="bo-input">
              ...
              <input
                ...
                value={user.zip}
                onChange={(e) =>
                  handleInputChange(index, "zip", e.target.value)
                }
              />
            </div>
            <div className="bo-input">
            ...
            <div className="bo-input">
              ...
              <label className="switch">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange(index, "activated", e.target.checked)
                  }
                />
